...
const uint8_t BootSect[] = {
    0xEB, 0x3C, 0x90, 0x4D, 0x53, 0x44, 0x4F, 0x53, 0x35, 0x2E, 0x30,   //  IGNORE
   
    0x00, 0x02,   // BYTES PER BLOCK     = MSC_BLOCKSIZE = 512        ( BLOCK = SECTOR )
    0x02,         // BLOCKS_PER_CLUSTER, = 2
    0x01, 0x00,   // NUMBER OF REZERVED BLOCKS = 1
    0x01,         // NUMBER OF FATs = 1
    0x02, 0x00,   // MAXIMUM NUMBER OF ROOT DIRECTORY ENTRIES = ( INITIAL A FOST 0X10, 0X00 , INSA ACUM PUN 2 => VOLUME LABEL FILE SI FIRMWARE.BIN)
    0xEC, 0x03,   // TOTAL BLOCK COUNT
    0xF8,         // IGNORE
    0x02, 0x00,   // BLOCKS PER FAT
    0x01, 0x00,   // BLOCKS PER TRACK
    0x01, 0x00,   // NUMBERS OF HEADS
    0x00,
    0x00
};
...
const uint8_t RootDirEntry[DIR_ENTRY] = {
    'B', 'o', 'o', 't', 'l', 'o', 'a','d',   // FILE NAME  8
    'e', 'r', ' ',                           // FILE EXTENSION  3
    0x28,                                    // FILE ATTRIBUTE 1
// BIT 0-R/O 
//     1-HIDDEN 
//     2-SYSTEM 
//     3-VOLUME LABEL 
...
//     5-ARCHIVE 
//     6-UNUSED 
//     7-UNUSED (0x28 = 0010 1000 => THIS FILE IS VOLUME LABEL & ARCHIVE)

    0x00,0x00,   // RESERVED 2
    0x00,0x00,   // CREATION TIME
    0x00,0x00,   // CREATION DATE
    0x00,0x00,   // LAST ACCESS DATE
    0x00,0x00,   // IGNORE IN FAT12
    0x00,0x00,   // LAST WRITE TIME
    0x00,0x00,   // LAST WRITE DATE
    0x00,0x00,   // FIRST LOGICAL CLUSTER
    0x00,0x00,0x00,0x00,   //FILE SIZE IN BYTES


    'U', 'p', 'l', 'o', 'a', 'd', ' ', 'h',
    'e', 'r', 'e',
    0x20,       // 0010 0000 => THIS FILE ATTRIBUTE IS ONLY ARCHIVE
    0x41,0x97,
    0x37,0x38,
    0x37,0x38,
    0x00,0x00,
