...
#define BIT31 0x80000000
  ...
  #define  LCD_CS_PIN		GPIO_Pin_13						// CS = PB[1]  *****************************AICI AM MODIFICAT
  ...
  #define  LCD_CS_HI()    	GPIOB->BSRR = LCD_CS_PIN    //  GPIO_WriteBit(LCD_CS_PORT,LCD_CS_PIN,Bit_SET)  
  #define  LCD_CS_LO() 		GPIOB->BRR = LCD_CS_PIN     //  GPIO_WriteBit(LCD_CS_PORT,LCD_CS_PIN,Bit_RESET)

  #define  LCD_SCLK_HI() 	GPIOB->BSRR = LCD_SCLK_PIN  //  GPIO_WriteBit(LCD_SCLK_PORT,LCD_SCLK_PIN,Bit_SET)
  #define  LCD_SCLK_LO() 	GPIOB->BRR = LCD_SCLK_PIN   //  GPIO_WriteBit(LCD_SCLK_PORT,LCD_SCLK_PIN,Bit_RESET)
   
  #define  LCD_SDATA_HI() 	GPIOB->BSRR = LCD_SDATA_PIN //  GPIO_WriteBit(LCD_SDATA_PORT,LCD_SDATA_PIN,Bit_SET)
  #define  LCD_SDATA_LO()	GPIOB->BRR = LCD_SDATA_PIN  //  GPIO_WriteBit(LCD_SDATA_PORT,LCD_SDATA_PIN,Bit_RESET)
  
  #define  LCD_RESET_HI() 	GPIOB->BSRR = LCD_RESET_PIN //  GPIO_WriteBit(LCD_RESET_PORT,LCD_RESET_PIN,Bit_SET)  
  #define  LCD_RESET_LO()	GPIOB->BRR = LCD_RESET_PIN  //  GPIO_WriteBit(LCD_RESET_PORT,LCD_RESET_PIN,Bit_RESET)
