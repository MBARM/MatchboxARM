...
/* Process noise covariance for the accelerometer - Sw */
const double Q_angleY = 0.001; 
/* Process noise covariance for the gyro - Sw */
const double Q_gyroY = 0.003; 
/* Measurement noise covariance - Sv */
const double R_angleY = 0.03; 

/* The angle output from the Kalman filter */
double angleY = 0;
/* The gyro bias calculated by the Kalman filter */
double biasY = 0; 
